                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={["max-w-[72%]", mine ? "text-right" : ""].join(" ")}>
                          ...
                          <div
                            className={[
                              "inline-block px-3 py-2 rounded-2xl text-sm whitespace-pre-wrap wrap-break-word",
                              mine
              ...
              <div className="border-t border-ink-100 p-3">
                <div className="flex gap-2">
                  <textarea
                    ...
                    className="flex-1 resize-none rounded-lg border border-ink-200 px-3 py-2 text-sm focus:outline-hidden focus:border-brand-blue"
                  />
                  <button
                    onClick={send}
